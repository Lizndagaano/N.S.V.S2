...
import com.example.nsvs.databinding.FragmentFeaturesBinding
...
class FeaturesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val myWebView: WebView = view.findViewById(R.id.webView_features)
        ...
        myWebView.loadUrl("https://nsvsnamugongo.com/index.php/features/")
