...
import com.example.nsvs.databinding.FragmentAcademicsBinding
...
class AcademicsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val myWebView: WebView = view.findViewById(R.id.webView_academics)
        ...
        myWebView.loadUrl("https://nsvsnamugongo.com/index.php/academics/")
