...
import com.example.nsvs.databinding.FragmentAboutUsBinding
...
class About_UsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val myWebView: WebView = view.findViewById(R.id.webView_about)
        ...
        myWebView.loadUrl("https://nsvsnamugongo.com/index.php/about-us/")
