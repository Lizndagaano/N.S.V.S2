...
import com.example.nsvs.databinding.FragmentGalleryBinding
...
class GalleryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val myWebView: WebView = view.findViewById(R.id.webView_gallery)
        ...
        myWebView.loadUrl("https://nsvsnamugongo.com/index.php/gallery/")
